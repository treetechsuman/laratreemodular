                ...
                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                  <tr>
                    <td class="pull-left mobile-header-padding-left" style="vertical-align: middle;">
                      <a href="#"><h2>Application Name</h2></a>
                    </td>
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="button">
            <form method="post" action="{{url(env('APP_URL', 'http://localhost:8000/admin/user/activate-user'))}}">
            {{csrf_field()}}
              <input type="hidden" name="activation_code" value="{{$activation_code}}">
              <div>
              <input type="submit" value="Activate" class="button-mobile" href="#"
              style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">My Account 
              >
              </div>
            </form>
            </td>
