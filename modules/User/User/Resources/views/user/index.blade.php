				...
				<table class="table table-condensed table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="{{url('admin/user/assign-role/'.$user['id'])}}" data-toggle="tooltip" title="Assign Role" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-edit"></i></a>
								...
								<a href="{{url('admin/user/user/delete/'.$user['id'])}}" data-toggle="tooltip" title="Delete" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-remove"></i></a></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
